...
import { useGetFacultyProfileQuery, useGetFacultyAssignmentsQuery, useUpdateFacultyProfileMutation } from '../state/facultyApi';
...
const FacultyProfilePage = () => {
  const { data: profile, isLoading: profileLoading } = useGetFacultyProfileQuery();
  ...
  const handleEdit = () => { setForm(toForm(profile)); setEditing(true); };
      ...
      {!editing ? (
        <Card>
          <div className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <Field label="Experience"    value={profile?.experience != null ? `${profile.experience} yr${profile.experience !== 1 ? 's' : ''}` : null} />
